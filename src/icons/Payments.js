const Payments = () => {
    return (
        <svg width="56" height="50" viewBox="0 0 60 54" className="mb-5 lg:h-[54px] lg:w-[60px]" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <rect width="58.1346" height="54" fill="white" transform="translate(0.932739)"/>
        </clipPath>
        </defs>
        </svg>
    )
